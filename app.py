...
:root {
    ...
    --surface-soft: #f7f6f2;
    --border-c: #e3e1d9;
    --border-strong-c: #c9c6ba;
    --text-primary-c: #24231f;
    --text-secondary-c: #6b6a63;
    --text-muted-c: #9c9a90;
}
...
[data-testid="stFileUploaderDropzone"] {
    background: var(--surface-soft);
    border: 1.5px dashed var(--border-strong-c);
    border-radius: 10px;
}
 
.chip-row { display: flex; flex-wrap: wrap; gap: 8px; margin: 6px 0 18px 0; }
.chip {
    background: var(--surface-soft);
...
@media (max-width: 640px) {
    ...
    [data-testid="stMetric"] { padding: 8px 6px 6px 6px; }
